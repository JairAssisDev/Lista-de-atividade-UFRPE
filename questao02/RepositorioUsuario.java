...
class RepositorioUsuario {
    ...
    /*public List<Usuario> listarUsuariosComIdadeAcimaDe(int idade) {
        List<Usuario> usuariosComIdadeAcimaDe = new ArrayList<>();
        for (Usuario u : usuarios) {
            if (u.getIdade() > idade) {
                usuariosComIdadeAcimaDe.add(u);
            }
        }
        return usuariosComIdadeAcimaDe;
    }*/
    ...
    /*public List<Usuario> listarUsuariosPorTipo(Class tipo) {
        List<Usuario> usuariosDoTipo = new ArrayList<>();
        for (Usuario u : usuarios) {
